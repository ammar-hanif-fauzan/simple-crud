...
@section('body')
        <h1 class="text-2xl font-bold mb-6">Create Hobby</h1>
            <form class="max-w-sm mx-auto flex flex-col gap-2 mt-4" action="{{ route('hobbies.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
